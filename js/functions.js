function uploadFile(docCode){
    ...
    fileReader.onload = (event) => {
        ...
        fetch("https://cdwebapsvr.fincadrc.com:8001/customer/loan/file/createorupdate", {
            method: "POST",
        ...
        .then(result => {
            ...
            if(result !== null && result.status === 'success'){
                ...
                linkObj.href = `https://cdwebapsvr.fincadrc.com:8001/customer/loan/file/view/${checkListId}`;
...
function saveCheckListChoice(docChkList, docCode){
    ...
    //Send request
    fetch("https://cdwebapsvr.fincadrc.com:8001/customer/loan/checklist/createorupdate", {
        method: "POST",
